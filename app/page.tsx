...
export default function Home() {
  return (
    <main className="relative min-h-screen flex flex-col items-center justify-start overflow-hidden bg-black text-neutral-50 selection:bg-indigo-500/30">
      ...
      <div className="absolute inset-0 bg-[linear-gradient(to_right,#ffffff05_1px,transparent_1px),linear-gradient(to_bottom,#ffffff05_1px,transparent_1px)] bg-size-[24px_32px] mask-[radial-gradient(ellipse_60%_50%_at_50%_0%,#000_70%,transparent_100%)] pointer-events-none"></div>
      ...
      <div className="relative z-10 flex flex-col items-center text-center px-4 max-w-4xl mx-auto mt-32">
        ...
        <div className="flex flex-col sm:flex-row gap-4 w-full sm:w-auto">
          ...
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="flex items-center justify-center gap-2 h-12 px-8 rounded-full glass-panel hover:bg-white/4 transition-colors font-medium text-white/90"
          >
      ...
      <div className="relative z-10 grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto mt-32 px-4 pb-20">
        ...
        <div className="flex flex-col items-center text-center p-6 glass-panel hover:bg-white/4 transition-colors">
